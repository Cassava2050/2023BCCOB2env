...
# bind both trials
sel_data <- sel_data %>% bind_rows(sel_data_1)
```
...
trial_standard_new <- trial_standard %>%
  mutate(obs_harvest_number_plan =
           case_when(str_detect(use_trial_name, "2023108") ~ 4,
                     str_detect(use_trial_name, "202363") ~ 4
                     # str_detect(use_trial_name, "202237") ~ 6,
                     # str_detect(use_trial_name, "202323") ~ 6,
                     # str_detect(use_trial_name, "202324") ~ 6,
                     # str_detect(use_trial_name, "202325") ~ 6
                     ),
